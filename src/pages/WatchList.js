  ...
  return (
    <>
      ...
      <div className="watchList-content mt-4 container">
        <div className="row h-100 justify-content-center gap-5 my-5">
          {current ? (
            Object.values(watchList).map((movie) => (
              ...
              >
                <img
                  ...
                  className="text-start  col-auto"
                  src={`https://image.tmdb.org/t/p/w500/${movie.poster_path}`}
                  alt="alt"
                />
                <div
                  className="ms-2 text-start content flex-1 col"
                  style={{ height: "350px" }}
                >
                  <div className="title d-flex align-items-center justify-content-between">
                    <h2 style={{ fontSize: "20px" }}>{movie.title}</h2>
                    <FontAwesomeIcon
                  ...
                  <p
                    className="text-start text-muted py-4 fs-8"
                    style={{
                      overflow: "hidden",
